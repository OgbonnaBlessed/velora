    ...
    <div className="flex flex-col gap-8 w-full">
        <div className=" xl:grid-cols-3 xl:gap-3 grid gap-4 md:gap-6 md:grid-cols-2 items-center">
            ...
            >
                ...
                <div className={`absolute top-16 left-0 font-sans z-20 bg-white p-4 shadow shadow-gray-300 rounded-xl text-sm w-52 flex flex-col gap-4 transition-all duration-300 ease-in-out
