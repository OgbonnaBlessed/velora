        ...
        <div className='flex flex-col gap-6 p-4 bg-[#dbeafe] rounded-md h-fit font-Grotesk'>
            ...
            {cancelBooking ? (
                <button 
                    ...
                    className="px-6 py-2 bg-[#48aadf] hover:bg-[#48aadf]/80 active:scale-90 text-white rounded-md text-nowrap max-sm:text-[0.7rem] transition-all duration-300 ease-in-out"
                    type="button"
                >
                    Cancel booking
                </button>
                ...
                <button
                    ...
                    className="bg-[#48aadf] hover:bg-[#48aadf]/80 active:scale-90 rounded-md font-semibold text-white cursor-pointer px-6 py-2 self-center transition-all duration-300 ease-in-out text-base"
                >
                    Select
                </button>
            )}
