...
const DestinationInput = ({ formData, setFormData, locations, label }) => {
    ...
    return (
        <div className='relative' ref={destinationRef}> {/* Wrapper div for the input and dropdown */}
            ...
            <div 
                className={`absolute top-16 bg-white max-h-64 overflow-y-auto shadow shadow-gray-300 rounded-lg w-64 transition-all duration-300 ease-in-out font-Roboto z-20
