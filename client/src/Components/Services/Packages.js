        ...
        {((flight && stay) || (flight && car)) &&
          ...
          >
            ...
            >
              ...
              <div 
                className={`bg-white shadow shadow-gray-300 rounded-xl flex flex-col absolute top-[3.3rem] font-serif font-[400] text-nowrap py-3 transform left-1/2 -translate-x-1/2 text-sm transition-all duration-300 ease-in-out z-20
                  ${flightClassModal 
